# Este é um plugin VST3 feito em C++ com JUCE. Um Oscilador "Modular" (que serve tanto como gerador de teste, quanto como coração de um possível sintetizador completo), contendo 4 controles essenciais.
